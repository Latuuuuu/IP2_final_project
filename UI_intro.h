#ifndef UIINTRO_H_INCLUDED
#define UIINTRO_H_INCLUDED
...
public:
	...
	void init() override {
		...
		int max_height = 0;
		// arrange tower shop
		for(size_t i = 0; i < (size_t)(IntroSetting::ButtonType::BUTTON_MAX); ++i) {
			ALLEGRO_BITMAP *bitmap = IC->get(IntroSetting::button_img_path[i]);
